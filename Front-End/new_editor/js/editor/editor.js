...
export class Editor {
    ...
    constructor() {
	this.baseURL = "https://mainline.i3s.unice.fr";
    ...
    loadKnobsImages(editorComponent) {
        ...
        fetch(this.baseURL + '/previews/knobs').then(function(response) {
    ...
    loadSlidersImages(editorComponent) {         
        fetch(this.baseURL + '/previews/sliders/body').then(function(response) {
            return response.json();
         }).then(data => {
             const baseURL = data.filesUrl;
             const files = data.files;
    ...
    loadSlidersKnobImages(editorComponent) {
        fetch(this.baseURL + '/previews/sliders/knobs').then(function(response) {
           return response.json();
        }).then(data => {
            const baseURL = data.filesUrl;
            const files = data.files;
    ...
    loadSwitchesImages(editorComponent) {         
        fetch(this.baseURL + '/previews/switches').then(function(response) {
            return response.json();
         }).then(data => {
             const baseURL = data.filesUrl;
             const files = data.files;
    ...
    loadLayoutImages(editorComponent) {
        fetch(this.baseURL + '/previews/backgrounds').then(function(response) {
            return response.json();
         }).then(data => {
             const baseURL = data.filesUrl;
             const files = data.files;
